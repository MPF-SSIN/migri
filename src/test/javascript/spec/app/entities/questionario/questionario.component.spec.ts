...
import { QuestionarioComponent } from 'app/entities/questionario/questionario.component';
...
describe('Component Tests', () => {
  describe('Questionario Management Component', () => {
    let comp: QuestionarioComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QuestionarioComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.questionarios && comp.questionarios[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
