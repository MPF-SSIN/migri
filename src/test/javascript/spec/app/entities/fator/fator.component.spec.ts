...
import { FatorComponent } from 'app/entities/fator/fator.component';
import { FatorService } from 'app/entities/fator/fator.service';
import { Fator } from 'app/shared/model/fator.model';

describe('Component Tests', () => {
  describe('Fator Management Component', () => {
    let comp: FatorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FatorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fators && comp.fators[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
